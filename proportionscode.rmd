...
dotplot +
  geom_pointrange(aes(ymin=percent-SE, ymax=percent+SE))+ 
  cleanup +
...
reasons$exp = 0
reasons$exp[ grep("exp", reasons$reason.code)] = 1
...
table(peep_data$people.or.data.points)

##create a data frame of the percentages
peep_datasummary = table(peep_data$people.or.data.points, peep_data$time.pulled, peep_data$Type)
